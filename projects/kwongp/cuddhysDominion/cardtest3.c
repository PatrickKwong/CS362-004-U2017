 ...
 *
 * Unit test for Council_room card using teammate (cuddhys)'s code
...
int main() {
    ...
    // council_room_func(G.handCount[0], &G); // my previous code
	// modifications to be able to use teammates's dominion.c cardEffect
	cardEffect(council_room, 0, 0, 0, &G, G.handCount[0], 0); // teammate didn't refactor council_room
